...
export default function Jumbotron() {
    ...
    const stats = [
        ...
        { icon: faBars, value: data?.total_active_report, label: 'Baru' },
        { icon: faList, value: data?.total_report_process, label: 'Proses' },
        { icon: faCheckSquare, value: data?.total_report_done, label: 'Penanganan Selesai' },
    ];
