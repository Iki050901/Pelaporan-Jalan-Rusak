...
export default function UsersForm({ initialData = null }) {
                ...
                <div className="col-span-full mt-10">
                    ...
                    <div className="mt-2">
                        <div className="grid shrink-0 grid-cols-1 focus-within:relative">
                            <select id="role_id" name="role_id" aria-label="Roles" className="col-start-1 row-start-1 w-full appearance-none outline-1 -outline-offset-1 outline-gray-300 rounded-md py-1.5 pr-7 pl-3 text-base text-gray-500 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-blue-600 sm:text-sm/6">
                                <option>DPRD</option>
                                <option>User</option>
                                <option>PUPR</option>
                            </select>
